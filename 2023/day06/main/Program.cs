...
var part2 = Day6.SolvePart2(input);

Console.WriteLine($"Part 2 solution: {part2}");

internal record Race(int Id, long Time, long Distance);

public static class Day6
{
    public static int SolvePart1(string input)
    {
        var races = ParsePart1(input);
        var sum = 1;
    ...
    private static List<Race> ParsePart1(string input)
    {
        ...
        foreach (var line in input.Split("\n", StringSplitOptions.TrimEntries | StringSplitOptions.RemoveEmptyEntries))
        {
            ...
            {
                if (part.EndsWith(':')) raceName = part.TrimEnd(':').ToLower();
    ...
    private static List<Race> ParsePart2(string input)
    {
        var dict = new Dictionary<string, IList<long>>();
        foreach (var line in input.Split("\n", StringSplitOptions.TrimEntries | StringSplitOptions.RemoveEmptyEntries))
        {
            var raceName = string.Empty;
            var nums = new List<int>();
            ...
            var num = long.Parse(string.Concat(nums));

            dict[raceName] = new List<long> { num };
        }

        var nn = dict.First().Value.Count();
        var res = new List<Race>();
